...
namespace CorseFromGround.Migrations
{
    ...
    [Migration("20170530225616_addintIdentity")]
    partial class addintIdentity
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CorseFromGround.DataAccess.WorldUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CorseFromGround.DataAccess.WorldUser")
                        .WithMany("Claims")
